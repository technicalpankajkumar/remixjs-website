...
export function ClientTestimonialSection() {
  ...
  const testimonials = [
    {
      quote:
        "Unicode Systems transformed our business operations with their innovative tech solutions. Their team's expertise and dedication made all the difference.",
    ...
    {
      quote:
        "Working with Unicode Systems has been a game-changer for our company. Their strategic approach and cutting-edge solutions helped us stay ahead of the competition.",
      author: "Michael Chen",
    ...
    {
      quote:
        "The team at Unicode Systems provided exceptional service and delivered results beyond our expectations. Their insights into our industry were invaluable.",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-600 max-w-2xl mx-auto">
            Don't just take our word for it. Here's what our clients have to say about working with Unicode Systems.
          </p>
        </div>

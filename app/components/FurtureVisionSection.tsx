      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-12">
          ...
          <p className="text-slate-600 max-w-4xl text-lg">
            At Unicode, we offer a broad spectrum of services, from custom website design to the development of
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mt-10 ">
          ...
          <div>
            ...
            <p className="text-slate-600 text-lg mb-8">
              At Unicode Systems, we are committed to delivering maximum value to our clients. Our belief in the
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-600 text-lg mb-4">
                As technology continues to evolve at a rapid pace, Unicode Systems remains at the forefront of
